return {
  ...
  -- nvim-telescope
  {
    ...
    -- Tambahkan fzf-native sebagai dependensi
    dependencies = {
      "nvim-telescope/telescope-fzf-native.nvim",
      -- Perintah build ini sangat penting
      build = "make",
    },
    opts = {
      -- Anda bisa menimpa atau menambah pengaturan Telescope di sini jika perlu
      -- Jika tidak, biarkan kosong untuk menggunakan default LazyVim
    },
    config = function(_, opts)
      -- Muat konfigurasi default Telescope dan gabungkan dengan opsi kustom Anda
      require("telescope").setup(opts)
      -- Muat ekstensi fzf-native
